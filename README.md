...
1. Clone the repository:
   ```bash
   git clone https://github.com/dhruvrajzala200/fullstack-dotnet-angular-app.git
   cd fullstack-dotnet-angular-app/src
   ```
...
https://github.com/Gramli/AuthApi.git
...
> [!NOTE]
> JWT Authentication default user credentials can be configured in [Auth.Infrastructure.Configuration.UsersConfiguration.cs](https://github.com/dhruvrajzala200/fullstack-dotnet-angular-app/blob/feature/multiple-auth-schemes/src/Auth.Infrastructure/Configuration/UsersConfiguration.cs) file.
